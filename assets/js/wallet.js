...
var options = {
  series: [
    {
      name: 'Earnings',
      data: [30, 25, 36, 30, 45, 35, 64, 51, 59],
    },
    {
      name: 'Students',
      data: [33, 21, 32, 37, 23, 32, 47, 31, 54],
    },
  ],
  chart: {
    height: 200,
  ...
  labels: ['2PM', '3PM', '4PM', '5PM', '6PM', '7PM', '8PM', '9PM', '10PM'],
  markers: {
    size: 0,
  },
  colors: ['#e9e9e9', 'rgb(132, 90, 223)'],
  plotOptions: {
    bar: {
      columnWidth: '40%',
      borderRadius: 2,
...
document.getElementById('ethreumChart').innerHTML = ''
var chart2 = new ApexCharts(document.querySelector('#ethreumChart'), options)
chart2.render()
function ethreumChart() {
